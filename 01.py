...
root.resizable(0,0)
root.title("Sergiu's Address-Book")

contactlist = [
    ['Jam Wilson',  '0176738493'],
    ['Roey Boey',  '2684430000'],
    ['Chu Pakabra',   '4338354432'],
    ['Pria Soelli','6834552341'],
    ['Raul Sting',   '1234852689'],
    ['Johen Seenot' , '2119876543'],
    ]
